...
// Import ScoreboardInstanceStore from commands
use crate::commands::monitor::ScoreboardInstanceStore;
pub struct ManagedScoreboardInstanceStore(pub Mutex<ScoreboardInstanceStore>);
